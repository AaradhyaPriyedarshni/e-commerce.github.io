...
<div class="container-fluid">
  <div class="box">
      <div class="welcome">
            <h2 class="text-center text-white py-5 ">Login </h2>
            <p class="text-center text-light ">Start Ordering Now </p>
      </div>
      <form action="">
            <div class="form-group mbnbr">
                ...
                <h6 class="text-success"><a href="#">Forget Password ?</a></h6>
                <button class="btn btn-lg btn-danger continue mt-5">Login</button><br><br>
                <h6>Dont have an account?<a href="registration.php" class="text-success">Register</a></h6>
